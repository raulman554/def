...
@section('header', 'Editar Instancia de Sorteo')
@section('content')
...
<div class="card">
  <div class="card-body">
    <form method="POST" action="{{ route('instancias-sorteo.update', $instancia->id) }}">
      @csrf
      @method('PUT')
      ...
      <div class="mb-3">
        ...
        <select name="tipo_sorteo_id" class="form-select" required>
          ...
          @foreach($tipos as $t)
            <option value="{{ $t->id }}" {{ old('tipo_sorteo_id', $instancia->tipo_sorteo_id) == $t->id ? 'selected' : '' }}>
        ...
        <div class="col-md-6 mb-3">
          ...
          <div class="input-group">
            ...
            <input type="datetime-local" name="fecha_inicio" class="form-control" required 
                  value="{{ old('fecha_inicio', $instancia->fecha_inicio instanceof \DateTime ? $instancia->fecha_inicio->format('Y-m-d\TH:i') : $instancia->fecha_inicio) }}">
          </div>
        ...
        <div class="col-md-6 mb-3">
          ...
          <div class="input-group">
            ...
            <input type="datetime-local" name="fecha_cierre" class="form-control" required
                  value="{{ old('fecha_cierre', $instancia->fecha_cierre instanceof \DateTime ? $instancia->fecha_cierre->format('Y-m-d\TH:i') : $instancia->fecha_cierre) }}">
          </div>
      ...
      <div class="mb-3">
        ...
        <div class="input-group">
          ...
          <input type="text" name="loteria_referencia" class="form-control"
                ...
                placeholder="Ej: Lotería Nacional - Sorteo Especial #123">
        </div>
        ...
        <div class="d-flex">
          <div class="form-check me-4">
            <input class="form-check-input" type="radio" name="estado" id="estado_pendiente" 
                  value="pendiente" {{ old('estado', $instancia->estado) == 'pendiente' ? 'checked' : '' }}>
          ...
          <div class="form-check me-4">
            <input class="form-check-input" type="radio" name="estado" id="estado_abierta" 
                  value="abierta" {{ old('estado', $instancia->estado) == 'abierta' ? 'checked' : '' }}>
          ...
          <div class="form-check">
            <input class="form-check-input" type="radio" name="estado" id="estado_cerrada" 
                  value="cerrada" {{ old('estado', $instancia->estado) == 'cerrada' ? 'checked' : '' }}>
      ...
      <div class="d-grid gap-2">
        <button type="submit" class="btn btn-primary">
          <i class="bi bi-check-circle"></i> Actualizar Instancia de Sorteo
        </button>
